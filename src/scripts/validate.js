...
const setEventListeners = (popupElement) => {
  const inputList = Array.from(popupElement.querySelectorAll(validationSettings.inputSelector));
  const buttonElement = popupElement.querySelector(validationSettings.submitButtonSelector);
...
export const enableValidation = () => {
  const popupList = Array.from(document.querySelectorAll(validationSettings.formSelector));
